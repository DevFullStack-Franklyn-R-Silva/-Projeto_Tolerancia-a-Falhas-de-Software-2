...
public class ServerUp2 {
	public static void main(String[] args) {
		...
		limiteOps = (ILimiteOps) compLimite.getProvidedInterface("ILimiteOps"); // Instancia do objeto que de fato é o
																				// conector
		try {
...
//			LocateRegistry.createRegistry(1098); // Criação da porta para levantar o servidor
